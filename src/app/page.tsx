                  ...
                  <div className="relative rounded-2xl bg-zinc-900/90 border border-zinc-700/50 overflow-hidden backdrop-blur-xl p-6">
                    ...
                    <div className="flex items-center gap-4 mb-5">
                      <img
                        src="/toly.jpg"
                        alt="toly"
                        className="w-16 h-16 rounded-xl object-cover shadow-lg shrink-0 ring-2 ring-zinc-700/50"
                      />
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-zinc-500">@toly</p>
                        <p className="text-zinc-400 text-xs mt-1">Co-founder of Solana Labs</p>
                      </div>
                    </div>
